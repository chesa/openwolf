# Requirements Archive: v1.1 Shared-Checkout Concurrency — Pillar C

**Archived:** 2026-06-24
**Status:** SHIPPED

No active-milestone requirements exist yet — the next milestone's
`.planning/REQUIREMENTS.md` is created when it begins (`/gsd-new-milestone`).
